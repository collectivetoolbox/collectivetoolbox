...
//! Direct-connect and data table definitions for EITE format systems.
...
mod tests {
    ...
    fn test_data_loaded() -> Result<()> {
        assert_eq!(dc_dataset_length("DcData")?, 301);
        assert_eq!(get_dc_count()?, 301);
        assert_eq!(maximum_known_dc()?, 300);
