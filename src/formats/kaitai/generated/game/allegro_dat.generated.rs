...
pub struct AllegroDat {
    pub(crate) _root: SharedType<AllegroDat>,
    pub(crate) _parent: SharedType<AllegroDat>,
...
pub struct AllegroDat_DatBitmap {
    pub(crate) _root: SharedType<AllegroDat>,
    pub(crate) _parent: SharedType<AllegroDat_DatObject>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct AllegroDat_DatFont16 {
    pub(crate) _root: SharedType<AllegroDat>,
    pub(crate) _parent: SharedType<AllegroDat_DatFont>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct AllegroDat_DatFont39_FontChar {
    pub(crate) _root: SharedType<AllegroDat>,
    pub(crate) _parent: SharedType<AllegroDat_DatFont39_Range>,
    pub(crate) _self_shared: SharedType<Self>,
    width: RefCell<u16>,
    height: RefCell<u16>,
    body: RefCell<Vec<u8>>,
...
pub struct AllegroDat_DatFont39_Range {
    pub(crate) _root: SharedType<AllegroDat>,
    pub(crate) _parent: SharedType<AllegroDat_DatFont39>,
    pub(crate) _self_shared: SharedType<Self>,
    mono: RefCell<u8>,
...
impl AllegroDat_DatObject {
    pub fn r#type(
        ...
        *self.r#type.borrow_mut() = self.properties().last().ok_or(KError::EmptyIterator)?.magic().to_string();
...
impl AllegroDat_Property {
    pub fn r#type(&self) -> Ref<'_, String> {
        self.r#type.borrow()
    }
}
impl AllegroDat_Property {
