...
pub struct QuakeMdl {
    pub(crate) _root: SharedType<QuakeMdl>,
    pub(crate) _parent: SharedType<QuakeMdl>,
...
pub struct QuakeMdl_MdlSimpleFrame {
    pub(crate) _root: SharedType<QuakeMdl>,
    pub(crate) _parent: SharedType<QuakeMdl_MdlFrame>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct QuakeMdl_Vec3 {
    pub(crate) _root: SharedType<QuakeMdl>,
    pub(crate) _parent: SharedType<QuakeMdl_MdlHeader>,
    pub(crate) _self_shared: SharedType<Self>,
    x: RefCell<f32>,
    y: RefCell<f32>,
    z: RefCell<f32>,
