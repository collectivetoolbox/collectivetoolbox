...
pub struct Quake2Md2 {
    pub(crate) _root: SharedType<Quake2Md2>,
    pub(crate) _parent: SharedType<Quake2Md2>,
...
impl Quake2Md2 {
    pub fn skins_raw(&self) -> Ref<'_, Vec<Vec<u8>>> {
...
pub struct Quake2Md2_CompressedVec {
    pub(crate) _root: SharedType<Quake2Md2>,
    pub(crate) _parent: SharedType<Quake2Md2_Vertex>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Quake2Md2_GlCmd {
    pub(crate) _root: SharedType<Quake2Md2>,
    pub(crate) _parent: SharedType<Quake2Md2_GlCmdsList>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Quake2Md2_GlVertex {
    pub(crate) _root: SharedType<Quake2Md2>,
    pub(crate) _parent: SharedType<Quake2Md2_GlCmd>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Quake2Md2_Vec3f {
    pub(crate) _root: SharedType<Quake2Md2>,
    pub(crate) _parent: SharedType<Quake2Md2_Frame>,
    pub(crate) _self_shared: SharedType<Self>,
    x: RefCell<f32>,
    y: RefCell<f32>,
    z: RefCell<f32>,
