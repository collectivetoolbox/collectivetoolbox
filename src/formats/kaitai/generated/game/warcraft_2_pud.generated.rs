...
pub struct Warcraft2Pud {
    pub(crate) _root: SharedType<Warcraft2Pud>,
    pub(crate) _parent: SharedType<Warcraft2Pud>,
...
pub struct Warcraft2Pud_SectionDim {
    pub(crate) _root: SharedType<Warcraft2Pud>,
    pub(crate) _parent: SharedType<Warcraft2Pud_Section>,
    pub(crate) _self_shared: SharedType<Self>,
    x: RefCell<u16>,
    y: RefCell<u16>,
    _io: RefCell<BytesReader>,
...
pub struct Warcraft2Pud_Unit {
    pub(crate) _root: SharedType<Warcraft2Pud>,
    pub(crate) _parent: SharedType<Warcraft2Pud_SectionUnit>,
    pub(crate) _self_shared: SharedType<Self>,
    x: RefCell<u16>,
    y: RefCell<u16>,
