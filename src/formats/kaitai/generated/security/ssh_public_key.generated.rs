...
pub struct SshPublicKey {
    pub(crate) _root: SharedType<SshPublicKey>,
    pub(crate) _parent: SharedType<SshPublicKey>,
...
pub struct SshPublicKey_EllipticCurve {
    pub(crate) _root: SharedType<SshPublicKey>,
    pub(crate) _parent: SharedType<SshPublicKey_KeyEcdsa>,
    pub(crate) _self_shared: SharedType<Self>,
    len: RefCell<u32>,
    body: RefCell<Vec<u8>>,
    _io: RefCell<BytesReader>,
...
impl SshPublicKey_KeyRsa {
    ...
    pub fn key_length(
        ...
        *self.key_length.borrow_mut() = (*self.rsa_n().length_in_bits()?).try_into()?;
