...
impl Bcd {
    ...
    pub fn as_int_be(
        ...
        *self.as_int_be.borrow_mut() = ((u64::try_from(u64::try_from(self.digits().get(usize::try_from(*self.last_idx()?)?).ok_or(KError::CastError)?)?)?).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(2))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(usize::try_from((*self.last_idx()?).saturating_sub(1_i32))?).ok_or(KError::CastError)?)?)?).saturating_mul(10_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(3))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(usize::try_from((*self.last_idx()?).saturating_sub(2_i32))?).ok_or(KError::CastError)?)?)?).saturating_mul(100_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(4))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(usize::try_from((*self.last_idx()?).saturating_sub(3_i32))?).ok_or(KError::CastError)?)?)?).saturating_mul(1000_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(5))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(usize::try_from((*self.last_idx()?).saturating_sub(4_i32))?).ok_or(KError::CastError)?)?)?).saturating_mul(10000_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(6))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(usize::try_from((*self.last_idx()?).saturating_sub(5_i32))?).ok_or(KError::CastError)?)?)?).saturating_mul(100000_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(7))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(usize::try_from((*self.last_idx()?).saturating_sub(6_i32))?).ok_or(KError::CastError)?)?)?).saturating_mul(1000000_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(8))) { 0_u64 } else { (u64::try_from(u64::try_from(self.digits().get(usize::try_from((*self.last_idx()?).saturating_sub(7_i32))?).ok_or(KError::CastError)?)?)?).saturating_mul(10000000_u64) }) }) }) }) }) }) })).try_into()?;
    ...
    pub fn as_int_le(
        ...
        *self.as_int_le.borrow_mut() = ((u64::try_from(u64::try_from(self.digits().get(0_usize).ok_or(KError::CastError)?)?)?).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(2))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(1_usize).ok_or(KError::CastError)?)?)?).saturating_mul(10_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(3))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(2_usize).ok_or(KError::CastError)?)?)?).saturating_mul(100_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(4))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(3_usize).ok_or(KError::CastError)?)?)?).saturating_mul(1000_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(5))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(4_usize).ok_or(KError::CastError)?)?)?).saturating_mul(10000_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(6))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(5_usize).ok_or(KError::CastError)?)?)?).saturating_mul(100000_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(7))) { 0_u64 } else { ((u64::try_from(u64::try_from(self.digits().get(6_usize).ok_or(KError::CastError)?)?)?).saturating_mul(1000000_u64)).saturating_add(if ((to_i128(*self.num_digits())) < (to_i128(8))) { 0_u64 } else { (u64::try_from(u64::try_from(self.digits().get(7_usize).ok_or(KError::CastError)?)?)?).saturating_mul(10000000_u64) }) }) }) }) }) }) })).try_into()?;
