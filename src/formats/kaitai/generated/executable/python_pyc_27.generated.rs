...
pub struct PythonPyc27 {
    pub(crate) _root: SharedType<PythonPyc27>,
    pub(crate) _parent: SharedType<PythonPyc27>,
...
impl KStruct for PythonPyc27 {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        let _io = io;
        *self_rc.version_magic.borrow_mut() = i64::try_from(_io.read_u2le()?)?.try_into()?;
...
pub struct PythonPyc27_Assembly {
    pub(crate) _root: SharedType<PythonPyc27>,
    pub(crate) _parent: SharedType<PythonPyc27_CodeObject>,
    pub(crate) _self_shared: SharedType<Self>,
...
impl KStruct for PythonPyc27_Assembly {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.string_magic.borrow_mut() = _io.read_bytes(usize::try_from(1)?)?;
...
impl KStruct for PythonPyc27_CodeObject {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.flags.borrow_mut() = i64::try_from(_io.read_u4le()?)?.try_into()?;
...
pub struct PythonPyc27_OpArg {
    pub(crate) _root: SharedType<PythonPyc27>,
    pub(crate) _parent: SharedType<PythonPyc27_OpArgs>,
    pub(crate) _self_shared: SharedType<Self>,
...
impl KStruct for PythonPyc27_OpArg {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.op_code.borrow_mut() = i64::try_from(_io.read_u1()?)?.try_into()?;
...
pub struct PythonPyc27_OpArgs {
    pub(crate) _root: SharedType<PythonPyc27>,
    pub(crate) _parent: SharedType<PythonPyc27_Assembly>,
    pub(crate) _self_shared: SharedType<Self>,
        ...
        *self_rc.items.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while !_io.is_eof() {
                let t = Self::read_into::<_, PythonPyc27_OpArg>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self_shared.clone()))?.into();
...
impl PythonPyc27_PyObject {
    pub fn r#type(&self) -> Ref<'_, PythonPyc27_PyObject_ObjectType> {
        self.r#type.borrow()
    }
}
impl PythonPyc27_PyObject {
