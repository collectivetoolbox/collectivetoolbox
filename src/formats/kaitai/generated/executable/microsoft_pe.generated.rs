...
pub struct MicrosoftPe {
    pub(crate) _root: SharedType<MicrosoftPe>,
    pub(crate) _parent: SharedType<MicrosoftPe>,
...
impl MicrosoftPe {
    pub fn pe(
        ...
        let _pos = _io.pos();
        _io.seek(usize::try_from(*self.mz().ofs_pe())?)?;
        let t = Self::read_into::<_, MicrosoftPe_PeHeader>(&*_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
...
pub struct MicrosoftPe_Annoyingstring {
    pub(crate) _root: SharedType<MicrosoftPe>,
    pub(crate) _parent: SharedType<MicrosoftPe_CoffSymbol>,
    pub(crate) _self_shared: SharedType<Self>,
    _io: RefCell<BytesReader>,
    f_name: Cell<bool>,
    name: RefCell<String>,
...
pub struct MicrosoftPe_CertificateEntry {
    pub(crate) _root: SharedType<MicrosoftPe>,
    pub(crate) _parent: SharedType<MicrosoftPe_CertificateTable>,
    pub(crate) _self_shared: SharedType<Self>,
    length: RefCell<u32>,
...
pub struct MicrosoftPe_CertificateTable {
    pub(crate) _root: SharedType<MicrosoftPe>,
    pub(crate) _parent: SharedType<MicrosoftPe_PeHeader>,
    pub(crate) _self_shared: SharedType<Self>,
...
impl MicrosoftPe_CoffHeader {
    ...
    pub fn symbol_name_table_size(
        ...
        let _pos = _io.pos();
        _io.seek(usize::try_from(*self.symbol_name_table_offset()?)?)?;
        *self.symbol_name_table_size.borrow_mut() = _io.read_u4le()?;
        _io.seek(_pos)?;
...
impl TryFrom<i64> for MicrosoftPe_CoffHeader_MachineType {
    ...
    fn try_from(flag: i64) -> KResult<MicrosoftPe_CoffHeader_MachineType> {
        match flag {
            ...
            _ => Ok(MicrosoftPe_CoffHeader_MachineType::UnknownVariant(flag)),
        }
    }
}
...
impl From<&MicrosoftPe_CoffHeader_MachineType> for i64 {
    fn from(v: &MicrosoftPe_CoffHeader_MachineType) -> Self {
        match *v {
            ...
            MicrosoftPe_CoffHeader_MachineType::UnknownVariant(v) => v
        }
    }
}

impl Default for MicrosoftPe_CoffHeader_MachineType {
    fn default() -> Self { MicrosoftPe_CoffHeader_MachineType::UnknownVariant(0) }
}
...
pub struct MicrosoftPe_CoffSymbol {
    pub(crate) _root: SharedType<MicrosoftPe>,
    pub(crate) _parent: SharedType<MicrosoftPe_CoffHeader>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct MicrosoftPe_DataDir {
    pub(crate) _root: SharedType<MicrosoftPe>,
    pub(crate) _parent: SharedType<MicrosoftPe_OptionalHeaderDataDirs>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct MicrosoftPe_OptionalHeaderDataDirs {
    pub(crate) _root: SharedType<MicrosoftPe>,
    pub(crate) _parent: SharedType<MicrosoftPe_OptionalHeader>,
    pub(crate) _self_shared: SharedType<Self>,
...
impl TryFrom<i64> for MicrosoftPe_OptionalHeaderWindows_SubsystemEnum {
    ...
    fn try_from(flag: i64) -> KResult<MicrosoftPe_OptionalHeaderWindows_SubsystemEnum> {
        match flag {
            ...
            _ => Ok(MicrosoftPe_OptionalHeaderWindows_SubsystemEnum::UnknownVariant(flag)),
        }
    }
}
...
impl From<&MicrosoftPe_OptionalHeaderWindows_SubsystemEnum> for i64 {
    fn from(v: &MicrosoftPe_OptionalHeaderWindows_SubsystemEnum) -> Self {
        match *v {
            ...
            MicrosoftPe_OptionalHeaderWindows_SubsystemEnum::UnknownVariant(v) => v
        }
    }
}

impl Default for MicrosoftPe_OptionalHeaderWindows_SubsystemEnum {
    fn default() -> Self { MicrosoftPe_OptionalHeaderWindows_SubsystemEnum::UnknownVariant(0) }
}
...
impl MicrosoftPe_Section {
    pub fn body(
        ...
        let _pos = _io.pos();
        _io.seek(usize::try_from(*self.pointer_to_raw_data())?)?;
