...
pub struct Swf {
    pub(crate) _root: SharedType<Swf>,
    pub(crate) _parent: SharedType<Swf>,
...
pub struct Swf_DefineSoundBody {
    pub(crate) _root: SharedType<Swf>,
    pub(crate) _parent: SharedType<Swf_Tag>,
    pub(crate) _self_shared: SharedType<Self>,
    id: RefCell<u16>,
    format: RefCell<u64>,
...
impl Swf_RecordHeader {
    ...
    pub fn tag_type(
        ...
        *self.tag_type.borrow_mut() = i64::from((i32::from(*self.tag_code_and_length())).wrapping_shr(6_u32)).try_into()?;
...
pub struct Swf_Rect {
    pub(crate) _root: SharedType<Swf>,
    pub(crate) _parent: SharedType<Swf_SwfBody>,
    pub(crate) _self_shared: SharedType<Self>,
    b1: RefCell<u8>,
    skip: RefCell<Vec<u8>>,
    _io: RefCell<BytesReader>,
...
pub struct Swf_SymbolClassBody_Symbol {
    pub(crate) _root: SharedType<Swf>,
    pub(crate) _parent: SharedType<Swf_SymbolClassBody>,
    pub(crate) _self_shared: SharedType<Self>,
    tag: RefCell<u16>,
    name: RefCell<String>,
    _io: RefCell<BytesReader>,
