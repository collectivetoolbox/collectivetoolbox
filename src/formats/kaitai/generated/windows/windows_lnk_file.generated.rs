...
pub struct WindowsLnkFile {
    pub(crate) _root: SharedType<WindowsLnkFile>,
    pub(crate) _parent: SharedType<WindowsLnkFile>,
...
impl TryFrom<i64> for WindowsLnkFile_DriveTypes {
    ...
    fn try_from(flag: i64) -> KResult<WindowsLnkFile_DriveTypes> {
        match flag {
            ...
            _ => Ok(WindowsLnkFile_DriveTypes::UnknownVariant(flag)),
        }
    }
}
...
impl From<&WindowsLnkFile_DriveTypes> for i64 {
    fn from(v: &WindowsLnkFile_DriveTypes) -> Self {
        match *v {
            ...
            WindowsLnkFile_DriveTypes::UnknownVariant(v) => v
        }
    }
}
...
pub struct WindowsLnkFile_LinkFlags {
    pub(crate) _root: SharedType<WindowsLnkFile>,
    pub(crate) _parent: SharedType<WindowsLnkFile_FileHeader>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct WindowsLnkFile_LinkInfo_All {
    pub(crate) _root: SharedType<WindowsLnkFile>,
    pub(crate) _parent: SharedType<WindowsLnkFile_LinkInfo>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct WindowsLnkFile_LinkInfo_Header {
    pub(crate) _root: SharedType<WindowsLnkFile>,
    pub(crate) _parent: SharedType<WindowsLnkFile_LinkInfo_All>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct WindowsLnkFile_LinkInfo_LinkInfoFlags {
    pub(crate) _root: SharedType<WindowsLnkFile>,
    pub(crate) _parent: SharedType<WindowsLnkFile_LinkInfo_Header>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct WindowsLnkFile_LinkInfo_VolumeIdBody {
    pub(crate) _root: SharedType<WindowsLnkFile>,
    pub(crate) _parent: SharedType<WindowsLnkFile_LinkInfo_VolumeIdSpec>,
    pub(crate) _self_shared: SharedType<Self>,
