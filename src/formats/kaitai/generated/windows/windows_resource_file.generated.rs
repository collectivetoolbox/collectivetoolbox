...
pub struct WindowsResourceFile {
    pub(crate) _root: SharedType<WindowsResourceFile>,
    pub(crate) _parent: SharedType<WindowsResourceFile>,
...
pub struct WindowsResourceFile_Resource {
    ...
    r#type: RefCell<OptRc<WindowsResourceFile_UnicodeOrId>>,
...
impl WindowsResourceFile_Resource {
    pub fn r#type(&self) -> Ref<'_, OptRc<WindowsResourceFile_UnicodeOrId>> {
        self.r#type.borrow()
    }
}
impl WindowsResourceFile_Resource {
...
pub struct WindowsResourceFile_UnicodeOrId {
    pub(crate) _root: SharedType<WindowsResourceFile>,
    pub(crate) _parent: SharedType<WindowsResourceFile_Resource>,
    pub(crate) _self_shared: SharedType<Self>,
    first: RefCell<u16>,
...
impl WindowsResourceFile_UnicodeOrId {
    ...
    pub fn save_pos2(
        ...
        *self.save_pos2.borrow_mut() = (_io.pos()).try_into()?;
