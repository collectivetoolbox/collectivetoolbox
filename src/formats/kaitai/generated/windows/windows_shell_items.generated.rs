...
pub struct WindowsShellItems {
    pub(crate) _root: SharedType<WindowsShellItems>,
    pub(crate) _parent: SharedType<WindowsShellItems>,
...
pub struct WindowsShellItems_FileEntryBody {
    pub(crate) _root: SharedType<WindowsShellItems>,
    pub(crate) _parent: SharedType<WindowsShellItems_ShellItemData>,
    pub(crate) _self_shared: SharedType<Self>,
    unnamed0: RefCell<u8>,
...
pub struct WindowsShellItems_ShellItemData {
    pub(crate) _root: SharedType<WindowsShellItems>,
    pub(crate) _parent: SharedType<WindowsShellItems_ShellItem>,
    pub(crate) _self_shared: SharedType<Self>,
    code: RefCell<u8>,
