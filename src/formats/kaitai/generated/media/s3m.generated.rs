...
pub struct S3m {
    pub(crate) _root: SharedType<S3m>,
    pub(crate) _parent: SharedType<S3m>,
...
pub struct S3m_Instrument {
    pub(crate) _root: SharedType<S3m>,
    pub(crate) _parent: SharedType<S3m_InstrumentPtr>,
    pub(crate) _self_shared: SharedType<Self>,
    r#type: RefCell<S3m_Instrument_InstTypes>,
...
impl S3m_Instrument {
    pub fn r#type(&self) -> Ref<'_, S3m_Instrument_InstTypes> {
        self.r#type.borrow()
    }
}
impl S3m_Instrument {
...
pub struct S3m_Instrument_Adlib {
    pub(crate) _root: SharedType<S3m>,
    pub(crate) _parent: SharedType<S3m_Instrument>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved1: RefCell<Vec<u8>>,
...
pub struct S3m_Pattern {
    pub(crate) _root: SharedType<S3m>,
    pub(crate) _parent: SharedType<S3m_PatternPtr>,
    pub(crate) _self_shared: SharedType<Self>,
    size: RefCell<u16>,
...
pub struct S3m_PatternCell {
    pub(crate) _root: SharedType<S3m>,
    pub(crate) _parent: SharedType<S3m_PatternCells>,
    pub(crate) _self_shared: SharedType<Self>,
    has_fx: RefCell<bool>,
...
pub struct S3m_PatternCells {
    pub(crate) _root: SharedType<S3m>,
    pub(crate) _parent: SharedType<S3m_Pattern>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct S3m_SwappedU3 {
    pub(crate) _root: SharedType<S3m>,
    pub(crate) _parent: SharedType<S3m_Instrument_Sampled>,
    pub(crate) _self_shared: SharedType<Self>,
    hi: RefCell<u8>,
    lo: RefCell<u16>,
    _io: RefCell<BytesReader>,
