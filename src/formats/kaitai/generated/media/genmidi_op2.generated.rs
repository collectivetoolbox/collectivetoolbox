...
pub struct GenmidiOp2 {
    pub(crate) _root: SharedType<GenmidiOp2>,
    pub(crate) _parent: SharedType<GenmidiOp2>,
...
pub struct GenmidiOp2_Instrument {
    pub(crate) _root: SharedType<GenmidiOp2>,
    pub(crate) _parent: SharedType<GenmidiOp2_InstrumentEntry>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct GenmidiOp2_OpSettings {
    pub(crate) _root: SharedType<GenmidiOp2>,
    pub(crate) _parent: SharedType<GenmidiOp2_Instrument>,
    pub(crate) _self_shared: SharedType<Self>,
