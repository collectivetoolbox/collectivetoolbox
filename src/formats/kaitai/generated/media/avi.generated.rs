...
pub struct Avi {
    pub(crate) _root: SharedType<Avi>,
    pub(crate) _parent: SharedType<Avi>,
...
pub struct Avi_AvihBody {
    pub(crate) _root: SharedType<Avi>,
    pub(crate) _parent: SharedType<Avi_Block>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Avi_Block {
    pub(crate) _root: SharedType<Avi>,
    pub(crate) _parent: SharedType<Avi_Blocks>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Avi_Rect {
    pub(crate) _root: SharedType<Avi>,
    pub(crate) _parent: SharedType<Avi_StrhBody>,
    pub(crate) _self_shared: SharedType<Self>,
    left: RefCell<i16>,
    top: RefCell<i16>,
    right: RefCell<i16>,
