...
pub struct QuicktimeMov {
    pub(crate) _root: SharedType<QuicktimeMov>,
    pub(crate) _parent: SharedType<QuicktimeMov>,
...
pub struct QuicktimeMov_Atom {
    pub(crate) _root: SharedType<QuicktimeMov>,
    pub(crate) _parent: SharedType<QuicktimeMov_AtomList>,
    pub(crate) _self_shared: SharedType<Self>,
    len32: RefCell<u32>,
...
pub struct QuicktimeMov_Fixed16 {
    pub(crate) _root: SharedType<QuicktimeMov>,
    pub(crate) _parent: SharedType<QuicktimeMov_MvhdBody>,
    pub(crate) _self_shared: SharedType<Self>,
    int_part: RefCell<i8>,
...
pub struct QuicktimeMov_FtypBody {
    pub(crate) _root: SharedType<QuicktimeMov>,
    pub(crate) _parent: SharedType<QuicktimeMov_Atom>,
    pub(crate) _self_shared: SharedType<Self>,
