...
pub struct PharWithoutStub {
    pub(crate) _root: SharedType<PharWithoutStub>,
    pub(crate) _parent: SharedType<PharWithoutStub>,
...
pub struct PharWithoutStub_ApiVersion {
    pub(crate) _root: SharedType<PharWithoutStub>,
    pub(crate) _parent: SharedType<PharWithoutStub_Manifest>,
    pub(crate) _self_shared: SharedType<Self>,
    release: RefCell<u64>,
    major: RefCell<u64>,
    minor: RefCell<u64>,
...
pub struct PharWithoutStub_FileFlags {
    pub(crate) _root: SharedType<PharWithoutStub>,
    pub(crate) _parent: SharedType<PharWithoutStub_FileEntry>,
    pub(crate) _self_shared: SharedType<Self>,
    value: RefCell<u32>,
    _io: RefCell<BytesReader>,
 ...
 */
impl PharWithoutStub_Signature {
    pub fn r#type(&self) -> Ref<'_, PharWithoutStub_SignatureType> {
        self.r#type.borrow()
    }
}
impl PharWithoutStub_Signature {
