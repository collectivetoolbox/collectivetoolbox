...
pub struct Zchunk {
    pub(crate) _root: SharedType<Zchunk>,
    pub(crate) _parent: SharedType<Zchunk>,
...
pub struct Zchunk_Chunk {
    pub(crate) _root: SharedType<Zchunk>,
    pub(crate) _parent: SharedType<Zchunk_Index>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Zchunk_CompressedInteger_Group {
    pub(crate) _root: SharedType<Zchunk>,
    pub(crate) _parent: SharedType<Zchunk_CompressedInteger>,
    pub(crate) _self_shared: SharedType<Self>,
    idx: RefCell<i32>,
...
pub struct Zchunk_Index {
    pub(crate) _root: SharedType<Zchunk>,
    pub(crate) _parent: SharedType<Zchunk_HeaderWithoutLead>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Zchunk_OptionalElement {
    pub(crate) _root: SharedType<Zchunk>,
    pub(crate) _parent: SharedType<Zchunk_Preface>,
    pub(crate) _self_shared: SharedType<Self>,
