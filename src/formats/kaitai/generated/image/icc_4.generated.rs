...
pub struct Icc4 {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4>,
...
impl KStruct for Icc4_DeviceManufacturer {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.device_manufacturer.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        Ok(())
    }
}
...
impl KStruct for Icc4_ProfileHeader {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.preferred_cmm_type.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        ...
        *self_rc.device_class.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        *self_rc.color_space.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        *self_rc.pcs.borrow_mut() = bytes_to_str(&_io.read_bytes(usize::try_from(4)?)?, "UTF-8")?;
        let t = Self::read_into::<_, Icc4_DateTimeNumber>(&*_io, Some(self_rc._root.clone()), None)?.into();
        *self_rc.creation_date_time.borrow_mut() = t;
        *self_rc.file_signature.borrow_mut() = _io.read_bytes(usize::try_from(4)?)?;
        ...
        *self_rc.primary_platform.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        ...
        *self_rc.device_model.borrow_mut() = bytes_to_str(&_io.read_bytes(usize::try_from(4)?)?, "UTF-8")?;
        ...
        *self_rc.rendering_intent.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        ...
        *self_rc.identifier.borrow_mut() = _io.read_bytes(usize::try_from(16)?)?;
        *self_rc.reserved_data.borrow_mut() = _io.read_bytes(usize::try_from(28)?)?;
        Ok(())
    }
}
...
pub struct Icc4_ProfileHeader_ProfileFlags {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_ProfileHeader>,
    pub(crate) _self_shared: SharedType<Self>,
...
impl KStruct for Icc4_ProfileHeader_VersionField {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.major.borrow_mut() = _io.read_bytes(usize::try_from(1)?)?;
...
impl KStruct for Icc4_S15Fixed16Number {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.number.borrow_mut() = _io.read_bytes(usize::try_from(4)?)?;
        Ok(())
    }
}
...
impl KStruct for Icc4_StandardIlluminantEncoding {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.standard_illuminant_encoding.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        Ok(())
    }
}
...
impl TryFrom<i64> for Icc4_StandardIlluminantEncoding_StandardIlluminantEncodings {
    ...
    fn try_from(flag: i64) -> KResult<Icc4_StandardIlluminantEncoding_StandardIlluminantEncodings> {
        match flag {
            ...
            _ => Ok(Icc4_StandardIlluminantEncoding_StandardIlluminantEncodings::UnknownVariant(flag)),
        }
    }
}
...
impl From<&Icc4_StandardIlluminantEncoding_StandardIlluminantEncodings> for i64 {
    fn from(v: &Icc4_StandardIlluminantEncoding_StandardIlluminantEncodings) -> Self {
        match *v {
            ...
            Icc4_StandardIlluminantEncoding_StandardIlluminantEncodings::UnknownVariant(v) => v
        }
    }
}

impl Default for Icc4_StandardIlluminantEncoding_StandardIlluminantEncodings {
    fn default() -> Self { Icc4_StandardIlluminantEncoding_StandardIlluminantEncodings::UnknownVariant(0) }
}
...
pub struct Icc4_TagTable_TagDefinition {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable>,
    pub(crate) _self_shared: SharedType<Self>,
...
impl KStruct for Icc4_TagTable_TagDefinition {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.tag_signature.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        *self_rc.offset_to_data_element.borrow_mut() = _io.read_u4be()?;
        *self_rc.size_of_data_element.borrow_mut() = _io.read_u4be()?;
        Ok(())
    }
...
impl Icc4_TagTable_TagDefinition {
    pub fn tag_data_element(
        ...
        let _pos = _io.pos();
        _io.seek(usize::try_from(*self.offset_to_data_element())?)?;
        match *self.tag_signature() {
            Icc4_TagTable_TagDefinition_TagSignatures::AToB0 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                ...
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_AToB0Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
            ...
            Icc4_TagTable_TagDefinition_TagSignatures::AToB1 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_AToB1Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::AToB2 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_AToB2Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::BToA0 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_BToA0Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::BToA1 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_BToA1Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::BToA2 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_BToA2Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::BToD0 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_BToD0Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::BToD1 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_BToD1Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::BToD2 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_BToD2Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::BToD3 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_BToD3Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::BlueMatrixColumn => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_BlueMatrixColumnTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::BlueTrc => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_BlueTrcTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::CalibrationDateTime => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_CalibrationDateTimeTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::CharTarget => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_CharTargetTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::ChromaticAdaptation => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ChromaticAdaptationTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::Chromaticity => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ChromaticityTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::ColorantOrder => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ColorantOrderTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::ColorantTable => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ColorantTableTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::ColorantTableOut => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ColorantTableOutTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::ColorimetricIntentImageState => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ColorimetricIntentImageStateTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::Copyright => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_CopyrightTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::DToB0 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_DToB0Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::DToB1 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_DToB1Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::DToB2 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_DToB2Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::DToB3 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_DToB3Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            ...
            Icc4_TagTable_TagDefinition_TagSignatures::Gamut => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_GamutTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::GrayTrc => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_GrayTrcTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::GreenMatrixColumn => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_GreenMatrixColumnTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::GreenTrc => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_GreenTrcTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::Luminance => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_LuminanceTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::Measurement => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_MeasurementTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::MediaWhitePoint => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_MediaWhitePointTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::NamedColor2 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_NamedColor2Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::OutputResponse => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_OutputResponseTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::PerceptualRenderingIntentGamut => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_PerceptualRenderingIntentGamutTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::Preview0 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_Preview0Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::Preview1 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_Preview1Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::Preview2 => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_Preview2Tag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::ProfileDescription => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ProfileDescriptionTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::ProfileSequence => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ProfileSequenceTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::ProfileSequenceIdentifier => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ProfileSequenceIdentifierTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::RedMatrixColumn => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_RedMatrixColumnTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::RedTrc => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_RedTrcTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::SaturationRenderingIntentGamut => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_SaturationRenderingIntentGamutTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            ...
            Icc4_TagTable_TagDefinition_TagSignatures::ViewingCondDesc => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ViewingCondDescTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            Icc4_TagTable_TagDefinition_TagSignatures::ViewingConditions => {
                *self.tag_data_element_raw.borrow_mut() = _io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into();
                let tag_data_element_raw = self.tag_data_element_raw.borrow();
                let _t_tag_data_element_raw_io = BytesReader::from(tag_data_element_raw.clone());
                let t = Self::read_into::<BytesReader, Icc4_TagTable_TagDefinition_ViewingConditionsTag>(&_t_tag_data_element_raw_io, Some(self._root.clone()), Some(self._self_shared.clone()))?.into();
                *self.tag_data_element.borrow_mut() = Some(t);
            }
            _ => {
                *self.tag_data_element.borrow_mut() = Some(_io.read_bytes(usize::try_from(*self.size_of_data_element())?)?.into());
            }
        }
        _io.seek(_pos)?;
...
pub struct Icc4_TagTable_TagDefinition_AToB0Tag {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition>,
    pub(crate) _self_shared: SharedType<Self>,
...
impl KStruct for Icc4_TagTable_TagDefinition_AToB0Tag {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.tag_type.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
...
pub struct Icc4_TagTable_TagDefinition_ChromaticityType {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ChromaticityTag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
...
impl KStruct for Icc4_TagTable_TagDefinition_ChromaticityType {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.colorant_and_phosphor_encoding.borrow_mut() = i64::try_from(_io.read_u2be()?)?.try_into()?;
...
impl TryFrom<i64> for Icc4_TagTable_TagDefinition_ChromaticityType_ColorantAndPhosphorEncodings {
    ...
    fn try_from(flag: i64) -> KResult<Icc4_TagTable_TagDefinition_ChromaticityType_ColorantAndPhosphorEncodings> {
        match flag {
            ...
            _ => Ok(Icc4_TagTable_TagDefinition_ChromaticityType_ColorantAndPhosphorEncodings::UnknownVariant(flag)),
        }
    }
}
...
impl From<&Icc4_TagTable_TagDefinition_ChromaticityType_ColorantAndPhosphorEncodings> for i64 {
    fn from(v: &Icc4_TagTable_TagDefinition_ChromaticityType_ColorantAndPhosphorEncodings) -> Self {
        match *v {
            ...
            Icc4_TagTable_TagDefinition_ChromaticityType_ColorantAndPhosphorEncodings::UnknownVariant(v) => v
        }
    }
}

impl Default for Icc4_TagTable_TagDefinition_ChromaticityType_ColorantAndPhosphorEncodings {
    fn default() -> Self { Icc4_TagTable_TagDefinition_ChromaticityType_ColorantAndPhosphorEncodings::UnknownVariant(0) }
}
...
pub struct Icc4_TagTable_TagDefinition_ChromaticityType_CiexyCoordinateValues {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ChromaticityType>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Icc4_TagTable_TagDefinition_ColorantOrderType {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ColorantOrderTag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
...
pub struct Icc4_TagTable_TagDefinition_ColorantTableType_Colorant {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ColorantTableType>,
    pub(crate) _self_shared: SharedType<Self>,
    name: RefCell<String>,
    ...
    fn read<S: KStream>(
        ...
        *self_rc.padding.borrow_mut() = Vec::new();
        ...
        for _i in 0..l_padding {
            self_rc.padding.borrow_mut().push(_io.read_bytes(usize::try_from(1)?)?);
        }
        ...
        *self_rc.pcs_values.borrow_mut() = _io.read_bytes(usize::try_from(6)?)?;
        Ok(())
    }
}
...
impl KStruct for Icc4_TagTable_TagDefinition_DataType {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.data_flag.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        Ok(())
    }
}
...
pub struct Icc4_TagTable_TagDefinition_DateTimeType {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_CalibrationDateTimeTag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
...
impl KStruct for Icc4_TagTable_TagDefinition_Lut16Type {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.input_tables.borrow_mut() = _io.read_bytes(usize::try_from(((((((2) as i32) * ((*self_rc.number_of_input_channels()) as i32))) as i32) * ((*self_rc.number_of_input_table_entries()) as i32)))?)?;
        *self_rc.clut_values.borrow_mut() = _io.read_bytes(usize::try_from(((((((2) as i32) * (((((*self_rc.number_of_clut_grid_points()) as u8) ^ ((*self_rc.number_of_input_channels()) as u8))) as i32))) as i32) * ((*self_rc.number_of_output_channels()) as i32)))?)?;
        *self_rc.output_tables.borrow_mut() = _io.read_bytes(usize::try_from(((((((2) as i32) * ((*self_rc.number_of_output_channels()) as i32))) as i32) * ((*self_rc.number_of_output_table_entries()) as i32)))?)?;
        Ok(())
    }
}
...
impl KStruct for Icc4_TagTable_TagDefinition_Lut8Type {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.input_tables.borrow_mut() = _io.read_bytes(usize::try_from((((256) as i32) * ((*self_rc.number_of_input_channels()) as i32)))?)?;
        *self_rc.clut_values.borrow_mut() = _io.read_bytes(usize::try_from(((((((*self_rc.number_of_clut_grid_points()) as u8) ^ ((*self_rc.number_of_input_channels()) as u8))) as u8) * ((*self_rc.number_of_output_channels()) as u8)))?)?;
        *self_rc.output_tables.borrow_mut() = _io.read_bytes(usize::try_from((((256) as i32) * ((*self_rc.number_of_output_channels()) as i32)))?)?;
        Ok(())
    }
}
...
impl KStruct for Icc4_TagTable_TagDefinition_LutAToBType {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.number_of_input_channels.borrow_mut() = _io.read_u1()?;
        *self_rc.number_of_output_channels.borrow_mut() = _io.read_u1()?;
        *self_rc.padding.borrow_mut() = _io.read_bytes(usize::try_from(2)?)?;
...
pub struct Icc4_TagTable_TagDefinition_MeasurementType {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_MeasurementTag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
...
impl KStruct for Icc4_TagTable_TagDefinition_MeasurementType {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.standard_observer_encoding.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        let t = Self::read_into::<_, Icc4_XyzNumber>(&*_io, Some(self_rc._root.clone()), None)?.into();
        *self_rc.nciexyz_tristimulus_values_for_measurement_backing.borrow_mut() = t;
        *self_rc.measurement_geometry_encoding.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        *self_rc.measurement_flare_encoding.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
...
impl TryFrom<i64> for Icc4_TagTable_TagDefinition_MeasurementType_MeasurementGeometryEncodings {
    ...
    fn try_from(flag: i64) -> KResult<Icc4_TagTable_TagDefinition_MeasurementType_MeasurementGeometryEncodings> {
        match flag {
            ...
            _ => Ok(Icc4_TagTable_TagDefinition_MeasurementType_MeasurementGeometryEncodings::UnknownVariant(flag)),
        }
    }
}
...
impl From<&Icc4_TagTable_TagDefinition_MeasurementType_MeasurementGeometryEncodings> for i64 {
    fn from(v: &Icc4_TagTable_TagDefinition_MeasurementType_MeasurementGeometryEncodings) -> Self {
        match *v {
            ...
            Icc4_TagTable_TagDefinition_MeasurementType_MeasurementGeometryEncodings::UnknownVariant(v) => v
        }
    }
}
...
impl TryFrom<i64> for Icc4_TagTable_TagDefinition_MeasurementType_StandardObserverEncodings {
    ...
    fn try_from(flag: i64) -> KResult<Icc4_TagTable_TagDefinition_MeasurementType_StandardObserverEncodings> {
        match flag {
            ...
            _ => Ok(Icc4_TagTable_TagDefinition_MeasurementType_StandardObserverEncodings::UnknownVariant(flag)),
        }
    }
}
...
impl From<&Icc4_TagTable_TagDefinition_MeasurementType_StandardObserverEncodings> for i64 {
    fn from(v: &Icc4_TagTable_TagDefinition_MeasurementType_StandardObserverEncodings) -> Self {
        match *v {
            ...
            Icc4_TagTable_TagDefinition_MeasurementType_StandardObserverEncodings::UnknownVariant(v) => v
        }
    }
}

impl Default for Icc4_TagTable_TagDefinition_MeasurementType_StandardObserverEncodings {
    fn default() -> Self { Icc4_TagTable_TagDefinition_MeasurementType_StandardObserverEncodings::UnknownVariant(0) }
}
...
pub struct Icc4_TagTable_TagDefinition_MultiLocalizedUnicodeType_Record {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_MultiLocalizedUnicodeType>,
    pub(crate) _self_shared: SharedType<Self>,
...
impl Icc4_TagTable_TagDefinition_MultiLocalizedUnicodeType_Record {
    pub fn string_data(
        ...
        let _pos = _io.pos();
        _io.seek(usize::try_from(*self.string_offset())?)?;
        *self.string_data.borrow_mut() = bytes_to_str(&_io.read_bytes(usize::try_from(*self.string_length())?)?, "UTF-16BE")?;
        _io.seek(_pos)?;
...
pub struct Icc4_TagTable_TagDefinition_NamedColor2Type {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_NamedColor2Tag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
    ...
    fn read<S: KStream>(
        ...
        *self_rc.prefix_for_each_colour_name_padding.borrow_mut() = Vec::new();
        ...
        for _i in 0..l_prefix_for_each_colour_name_padding {
            self_rc.prefix_for_each_colour_name_padding.borrow_mut().push(_io.read_bytes(usize::try_from(1)?)?);
        }
        ...
        *self_rc.suffix_for_each_colour_name_padding.borrow_mut() = Vec::new();
        ...
        for _i in 0..l_suffix_for_each_colour_name_padding {
            self_rc.suffix_for_each_colour_name_padding.borrow_mut().push(_io.read_bytes(usize::try_from(1)?)?);
        }
...
pub struct Icc4_TagTable_TagDefinition_NamedColor2Type_NamedColourDefinition {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_NamedColor2Type>,
    pub(crate) _self_shared: SharedType<Self>,
    ...
    fn read<S: KStream>(
        ...
        *self_rc.root_name_padding.borrow_mut() = Vec::new();
        ...
        for _i in 0..l_root_name_padding {
            self_rc.root_name_padding.borrow_mut().push(_io.read_bytes(usize::try_from(1)?)?);
        }
        ...
        *self_rc.pcs_coordinates.borrow_mut() = _io.read_bytes(usize::try_from(6)?)?;
        if (((*self_rc._parent.get_value().borrow().upgrade().as_ref().ok_or(KError::MissingParent)?.number_of_device_coordinates_for_each_named_colour()) as u32) > ((0) as u32)) {
...
impl KStruct for Icc4_TagTable_TagDefinition_ParametricCurveType {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.function_type.borrow_mut() = i64::try_from(_io.read_u2be()?)?.try_into()?;
        *self_rc.reserved_2.borrow_mut() = _io.read_bytes(usize::try_from(2)?)?;
...
pub struct Icc4_TagTable_TagDefinition_ParametricCurveType_ParamsCie1221996 {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ParametricCurveType>,
    pub(crate) _self_shared: SharedType<Self>,
    g: RefCell<i32>,
    a: RefCell<i32>,
    b: RefCell<i32>,
...
pub struct Icc4_TagTable_TagDefinition_ProfileSequenceDescType {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ProfileSequenceTag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
...
pub struct Icc4_TagTable_TagDefinition_ProfileSequenceDescType_ProfileDescription {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ProfileSequenceDescType>,
    pub(crate) _self_shared: SharedType<Self>,
    device_manufacturer: RefCell<OptRc<Icc4_DeviceManufacturer>>,
    device_model: RefCell<String>,
    device_attributes: RefCell<OptRc<Icc4_DeviceAttributes>>,
...
pub struct Icc4_TagTable_TagDefinition_ProfileSequenceIdentifierType {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ProfileSequenceIdentifierTag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
...
pub struct Icc4_TagTable_TagDefinition_ProfileSequenceIdentifierType_ProfileIdentifier {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ProfileSequenceIdentifierType>,
    pub(crate) _self_shared: SharedType<Self>,
...
impl KStruct for Icc4_TagTable_TagDefinition_ProfileSequenceIdentifierType_ProfileIdentifier {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.profile_id.borrow_mut() = _io.read_bytes(usize::try_from(16)?)?;
...
pub struct Icc4_TagTable_TagDefinition_ResponseCurveSet16Type {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_OutputResponseTag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
...
pub struct Icc4_TagTable_TagDefinition_S15Fixed16ArrayType {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ChromaticAdaptationTag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
...
impl KStruct for Icc4_TagTable_TagDefinition_SignatureType {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.signature.borrow_mut() = bytes_to_str(&_io.read_bytes(usize::try_from(4)?)?, "UTF-8")?;
        Ok(())
    }
}
...
pub struct Icc4_TagTable_TagDefinition_TextType {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_CharTargetTag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
        ...
        *self_rc.values.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while !_io.is_eof() {
                let t = Self::read_into::<_, Icc4_U16Fixed16Number>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self_shared.clone()))?.into();
                self_rc.values.borrow_mut().push(t);
                _i += 1;
            }
        }
...
pub struct Icc4_TagTable_TagDefinition_ViewingConditionsType {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_ViewingConditionsTag>,
    pub(crate) _self_shared: SharedType<Self>,
    reserved: RefCell<Vec<u8>>,
...
pub struct Icc4_U16Fixed16Number {
    pub(crate) _root: SharedType<Icc4>,
    pub(crate) _parent: SharedType<Icc4_TagTable_TagDefinition_U16Fixed16ArrayType>,
    pub(crate) _self_shared: SharedType<Self>,
    number: RefCell<Vec<u8>>,
    _io: RefCell<BytesReader>,
}
...
impl KStruct for Icc4_U1Fixed15Number {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.number.borrow_mut() = _io.read_bytes(usize::try_from(2)?)?;
        Ok(())
    }
}
...
impl KStruct for Icc4_XyzNumber {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.x.borrow_mut() = _io.read_bytes(usize::try_from(4)?)?;
        *self_rc.y.borrow_mut() = _io.read_bytes(usize::try_from(4)?)?;
        *self_rc.z.borrow_mut() = _io.read_bytes(usize::try_from(4)?)?;
        Ok(())
    }
}
impl Icc4_XyzNumber {
