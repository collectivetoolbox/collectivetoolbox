...
pub struct Gif {
    pub(crate) _root: SharedType<Gif>,
    pub(crate) _parent: SharedType<Gif>,
...
pub struct Gif_ApplicationId {
    pub(crate) _root: SharedType<Gif>,
    pub(crate) _parent: SharedType<Gif_ExtApplication>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Gif_ColorTableEntry {
    pub(crate) _root: SharedType<Gif>,
    pub(crate) _parent: SharedType<Gif_ColorTable>,
    pub(crate) _self_shared: SharedType<Self>,
    red: RefCell<u8>,
    green: RefCell<u8>,
    blue: RefCell<u8>,
...
pub struct Gif_ExtApplication {
    pub(crate) _root: SharedType<Gif>,
    pub(crate) _parent: SharedType<Gif_Extension>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Gif_Extension {
    pub(crate) _root: SharedType<Gif>,
    pub(crate) _parent: SharedType<Gif_Block>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Gif_ImageData {
    pub(crate) _root: SharedType<Gif>,
    pub(crate) _parent: SharedType<Gif_LocalImageDescriptor>,
    pub(crate) _self_shared: SharedType<Self>,
