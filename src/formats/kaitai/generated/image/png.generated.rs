...
pub struct Png {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png>,
...
impl TryFrom<i64> for Png_PhysUnit {
    ...
    fn try_from(flag: i64) -> KResult<Png_PhysUnit> {
        match flag {
            ...
            _ => Ok(Png_PhysUnit::UnknownVariant(flag)),
        }
    }
}
...
impl From<&Png_PhysUnit> for i64 {
    fn from(v: &Png_PhysUnit) -> Self {
        match *v {
            ...
            Png_PhysUnit::UnknownVariant(v) => v
        }
    }
}

impl Default for Png_PhysUnit {
    fn default() -> Self { Png_PhysUnit::UnknownVariant(0) }
}
...
pub struct Png_AdobeFireworksChunk {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png_Chunk>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Png_BkgdGreyscale {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png_BkgdChunk>,
    pub(crate) _self_shared: SharedType<Self>,
    value: RefCell<u16>,
    _io: RefCell<BytesReader>,
}
...
pub struct Png_ChrmChromaticity {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png_ChrmChunk>,
    pub(crate) _self_shared: SharedType<Self>,
    x_int: RefCell<u32>,
    y_int: RefCell<u32>,
    _io: RefCell<BytesReader>,
...
impl Png_Chunk {
    ...
    pub fn r#type(
        ...
        *self.r#type.borrow_mut() = bytes_to_str(&self.type_raw(), "ASCII")?.to_string();
...
pub struct Png_CompressedText {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png_CompressedTextChunk>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Png_InternationalText {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png_InternationalTextChunk>,
    pub(crate) _self_shared: SharedType<Self>,
    value: RefCell<String>,
    _io: RefCell<BytesReader>,
}
...
pub struct Png_MdcvChromaticity {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png_MdcvChunk>,
    pub(crate) _self_shared: SharedType<Self>,
    x_int: RefCell<u16>,
    y_int: RefCell<u16>,
    _io: RefCell<BytesReader>,
...
pub struct Png_Rgb {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png_PlteChunk>,
    pub(crate) _self_shared: SharedType<Self>,
    r: RefCell<u8>,
    g: RefCell<u8>,
    b: RefCell<u8>,
...
pub struct Png_SbitGreyscale {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png_SbitChunk>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Png_SpltEntry {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png_SpltChunk>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct Png_TrnsGreyscaleColor {
    pub(crate) _root: SharedType<Png>,
    pub(crate) _parent: SharedType<Png_TrnsChunk>,
    pub(crate) _self_shared: SharedType<Self>,
