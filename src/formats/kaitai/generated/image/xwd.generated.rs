...
impl KStruct for Xwd_Header {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.pixmap_format.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        ...
        *self_rc.byte_order.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
        ...
        *self_rc.visual_class.borrow_mut() = i64::try_from(_io.read_u4be()?)?.try_into()?;
