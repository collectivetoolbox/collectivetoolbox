...
pub struct GimpBrush {
    pub(crate) _root: SharedType<GimpBrush>,
    pub(crate) _parent: SharedType<GimpBrush>,
...
impl GimpBrush {
    pub fn body(
        ...
        let _pos = _io.pos();
        _io.seek(usize::try_from(*self.len_header())?)?;
...
pub struct GimpBrush_Row {
    pub(crate) _root: SharedType<GimpBrush>,
    pub(crate) _parent: SharedType<GimpBrush_Bitmap>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct GimpBrush_Row_PixelGray {
    pub(crate) _root: SharedType<GimpBrush>,
    pub(crate) _parent: SharedType<GimpBrush_Row>,
    pub(crate) _self_shared: SharedType<Self>,
    gray: RefCell<u8>,
    _io: RefCell<BytesReader>,
    f_alpha: Cell<bool>,
...
impl GimpBrush_Row_PixelGray {
    ...
    pub fn red(
        ...
        self.f_red.set(true);
        *self.red.borrow_mut() = (0).try_into()?;
        Ok(self.red.borrow())
    }
}
impl GimpBrush_Row_PixelGray {
