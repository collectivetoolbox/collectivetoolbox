...
pub struct GptPartitionTable {
    pub(crate) _root: SharedType<GptPartitionTable>,
    pub(crate) _parent: SharedType<GptPartitionTable>,
...
pub struct GptPartitionTable_PartitionEntry {
    pub(crate) _root: SharedType<GptPartitionTable>,
    pub(crate) _parent: SharedType<GptPartitionTable_PartitionHeader>,
    pub(crate) _self_shared: SharedType<Self>,
