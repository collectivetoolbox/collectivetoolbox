...
pub struct BtrfsStream {
    pub(crate) _root: SharedType<BtrfsStream>,
    pub(crate) _parent: SharedType<BtrfsStream>,
        ...
        *self_rc.commands.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while !_io.is_eof() {
                let t = Self::read_into::<_, BtrfsStream_SendCommand>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self_shared.clone()))?.into();
...
pub struct BtrfsStream_SendCommand {
    ...
    r#type: RefCell<BtrfsStream_Command>,
...
impl KStruct for BtrfsStream_SendCommand {
    ...
    fn read<S: KStream>(
        ...
        *self_rc.checksum.borrow_mut() = _io.read_bytes(usize::try_from(4)?)?;
...
impl BtrfsStream_SendCommand {
    pub fn r#type(&self) -> Ref<'_, BtrfsStream_Command> {
        self.r#type.borrow()
    }
}
...
pub struct BtrfsStream_SendCommand_String {
    pub(crate) _root: SharedType<BtrfsStream>,
    pub(crate) _parent: SharedType<BtrfsStream_SendCommand_Tlv>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct BtrfsStream_SendCommand_Tlv {
    pub(crate) _root: SharedType<BtrfsStream>,
    pub(crate) _parent: SharedType<BtrfsStream_SendCommand_Tlvs>,
    pub(crate) _self_shared: SharedType<Self>,
    r#type: RefCell<BtrfsStream_Attribute>,
    length: RefCell<u16>,
...
impl BtrfsStream_SendCommand_Tlv {
    pub fn r#type(&self) -> Ref<'_, BtrfsStream_Attribute> {
        self.r#type.borrow()
    }
}
impl BtrfsStream_SendCommand_Tlv {
...
pub struct BtrfsStream_SendCommand_Tlvs {
    pub(crate) _root: SharedType<BtrfsStream>,
    pub(crate) _parent: SharedType<BtrfsStream_SendCommand>,
    pub(crate) _self_shared: SharedType<Self>,
        ...
        *self_rc.tlv.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while !_io.is_eof() {
                let t = Self::read_into::<_, BtrfsStream_SendCommand_Tlv>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self_shared.clone()))?.into();
...
impl KStruct for BtrfsStream_SendStreamHeader {
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = io.clone();
        ...
        self_rc._self_shared.set(Ok(self_rc.clone()));
        let _io = io;
        *self_rc.magic.borrow_mut() = _io.read_bytes(usize::try_from(13)?)?;
