...
pub struct DnsPacket {
    pub(crate) _root: SharedType<DnsPacket>,
    pub(crate) _parent: SharedType<DnsPacket>,
...
pub struct DnsPacket_Address {
    pub(crate) _root: SharedType<DnsPacket>,
    pub(crate) _parent: SharedType<DnsPacket_Answer>,
    pub(crate) _self_shared: SharedType<Self>,
    ip: RefCell<Vec<u8>>,
    _io: RefCell<BytesReader>,
}
...
impl DnsPacket_Answer {
    pub fn r#type(&self) -> Ref<'_, DnsPacket_TypeType> {
        self.r#type.borrow()
    }
}
impl DnsPacket_Answer {
...
pub struct DnsPacket_Label {
    pub(crate) _root: SharedType<DnsPacket>,
    pub(crate) _parent: SharedType<DnsPacket_DomainName>,
    pub(crate) _self_shared: SharedType<Self>,
    length: RefCell<u8>,
...
pub struct DnsPacket_PointerStruct {
    pub(crate) _root: SharedType<DnsPacket>,
    pub(crate) _parent: SharedType<DnsPacket_Label>,
    pub(crate) _self_shared: SharedType<Self>,
    value: RefCell<u8>,
    _io: RefCell<BytesReader>,
...
pub struct DnsPacket_Txt {
    pub(crate) _root: SharedType<DnsPacket>,
    pub(crate) _parent: SharedType<DnsPacket_TxtBody>,
    pub(crate) _self_shared: SharedType<Self>,
    length: RefCell<u8>,
    text: RefCell<String>,
    _io: RefCell<BytesReader>,
