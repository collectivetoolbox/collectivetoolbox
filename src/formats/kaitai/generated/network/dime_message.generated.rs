...
pub struct DimeMessage {
    pub(crate) _root: SharedType<DimeMessage>,
    pub(crate) _parent: SharedType<DimeMessage>,
...
impl TryFrom<i64> for DimeMessage_TypeFormats {
    ...
    fn try_from(flag: i64) -> KResult<DimeMessage_TypeFormats> {
        match flag {
            ...
            _ => Ok(DimeMessage_TypeFormats::UnknownVariant(flag)),
        }
    }
}
...
impl From<&DimeMessage_TypeFormats> for i64 {
    fn from(v: &DimeMessage_TypeFormats) -> Self {
        match *v {
            ...
            DimeMessage_TypeFormats::UnknownVariant(v) => v
        }
    }
}

impl Default for DimeMessage_TypeFormats {
    fn default() -> Self { DimeMessage_TypeFormats::UnknownVariant(0) }
}
...
pub struct DimeMessage_OptionElement {
    pub(crate) _root: SharedType<DimeMessage>,
    pub(crate) _parent: SharedType<DimeMessage_OptionField>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct DimeMessage_OptionField {
    pub(crate) _root: SharedType<DimeMessage>,
    pub(crate) _parent: SharedType<DimeMessage_Record>,
    pub(crate) _self_shared: SharedType<Self>,
