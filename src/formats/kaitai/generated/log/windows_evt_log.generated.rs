...
pub struct WindowsEvtLog {
    pub(crate) _root: SharedType<WindowsEvtLog>,
    pub(crate) _parent: SharedType<WindowsEvtLog>,
...
pub struct WindowsEvtLog_CursorRecordBody {
    pub(crate) _root: SharedType<WindowsEvtLog>,
    pub(crate) _parent: SharedType<WindowsEvtLog_Record>,
    pub(crate) _self_shared: SharedType<Self>,
...
pub struct WindowsEvtLog_Header_Flags {
    pub(crate) _root: SharedType<WindowsEvtLog>,
    pub(crate) _parent: SharedType<WindowsEvtLog_Header>,
    pub(crate) _self_shared: SharedType<Self>,
