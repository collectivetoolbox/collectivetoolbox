...
use twox_hash::{XxHash32, XxHash64, XxHash3_64, XxHash3_128};
...
mod tests {
    ...
    #[crate::ctb_test]
    fn test_xxhash64() {
        assert_eq!(xxhash64(&[]), [0xef, 0x46, 0xdb, 0x37, 0x51, 0xd8, 0xe9, 0x99]);
        assert_eq!(xxhash64(b"hello world"), [0x45, 0xab, 0x67, 0x34, 0xb2, 0x1e, 0x69, 0x68]);
    }

    #[crate::ctb_test]
    fn test_xxhash3_64() {
        assert_eq!(xxhash3_64(&[]), [0x2d, 0x06, 0x80, 0x05, 0x38, 0xd3, 0x94, 0xc2]);
        assert_eq!(xxhash3_64(b"hello world"), [0xd4, 0x47, 0xb1, 0xea, 0x40, 0xe6, 0x98, 0x8b]);
    }
    ...
    fn test_xxhash3_128() {
        ...
        assert_eq!(
            ...
            [
                0xdf, 0x8d, 0x09, 0xe9, 0x3f, 0x87, 0x49, 0x00,
                0xa9, 0x9b, 0x87, 0x75, 0xcc, 0x15, 0xb6, 0xc7
            ]
        );
    }
}